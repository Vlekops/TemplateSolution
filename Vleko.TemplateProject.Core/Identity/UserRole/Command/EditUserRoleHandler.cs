...
namespace Vleko.TemplateProject.Core.UserRole.Command
{
    ...
    public class EditUserRoleRequest :UserRoleRequest, IMapRequest<Vleko.TemplateProject.Data.Model.UserRole, EditUserRoleRequest>,IRequest<StatusResponse>
    {
        [Required]
        public Guid Id { get; set; }
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<EditUserRoleRequest, Vleko.TemplateProject.Data.Model.UserRole> map)
        {
    ...
    internal class EditUserRoleHandler : IRequestHandler<EditUserRoleRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(EditUserRoleRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var existingItems = await _context.Entity<Vleko.TemplateProject.Data.Model.UserRole>().Where(d => d.Id == request.Id).FirstOrDefaultAsync();
