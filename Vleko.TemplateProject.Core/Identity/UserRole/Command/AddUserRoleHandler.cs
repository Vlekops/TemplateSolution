...
namespace Vleko.TemplateProject.Core.UserRole.Command
{
    ...
    public class AddUserRoleRequest :UserRoleRequest, IMapRequest<Vleko.TemplateProject.Data.Model.UserRole, AddUserRoleRequest>,IRequest<StatusResponse>
    {
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<AddUserRoleRequest, Vleko.TemplateProject.Data.Model.UserRole> map)
        {
    ...
    internal class AddUserRoleHandler : IRequestHandler<AddUserRoleRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(AddUserRoleRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var data = _mapper.Map<Vleko.TemplateProject.Data.Model.UserRole>(request);
