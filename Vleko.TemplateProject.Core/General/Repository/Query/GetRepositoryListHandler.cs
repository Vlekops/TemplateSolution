...
namespace Vleko.TemplateProject.Core.Repository.Query
{
    ...
    internal class GetRepositoryListHandler : IRequestHandler<GetRepositoryListRequest, ListResponse<RepositoryResponse>>
    {
        ...
        public async Task<ListResponse<RepositoryResponse>> Handle(GetRepositoryListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<Vleko.TemplateProject.Data.Model.Repository>().AsQueryable();

				#region Filter
				Expression<Func<Vleko.TemplateProject.Data.Model.Repository, object>> column_sort = null;
				List<Expression<Func<Vleko.TemplateProject.Data.Model.Repository, bool>>> where = new List<Expression<Func<Vleko.TemplateProject.Data.Model.Repository, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<Vleko.TemplateProject.Data.Model.Repository, bool>> where, Expression<Func<Vleko.TemplateProject.Data.Model.Repository, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Vleko.TemplateProject.Data.Model.Repository, object>> result_order = null;
			Expression<Func<Vleko.TemplateProject.Data.Model.Repository, bool>> result_where = null;
