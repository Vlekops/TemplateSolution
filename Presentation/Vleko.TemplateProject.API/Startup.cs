...
using Vleko.TemplateProject.Core;
using Vleko.TemplateProject.Data;
using Vleko.TemplateProject.Shared;
using Vleko.TemplateProject.API.Handler;
using Hangfire;
using Hangfire.SqlServer;
using HangfireBasicAuthenticationFilter;
using Microsoft.AspNetCore.Mvc;
using Vleko.TemplateProject.Infrastructure.Mail;
...
namespace Vleko.TemplateProject.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AddJwtBearer(x =>
           {
            ...
            if (_environment.IsDevelopment())
            {
                ...
                {
                    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Vleko.TemplateProject.API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.DocumentTitle = "Vleko.TemplateProject.API";
